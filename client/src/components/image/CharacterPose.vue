...
import * as mannequin from '@/components/image/mannequin'
...
export default{
    ...
    mount(){
        const canvasScene = mannequin.createScene("canvasElement")
        const canvasElement = document.getElementById("canvasElement")
        canvasElement.appendChild(canvasScene.renderer.domElement)
    }
}
